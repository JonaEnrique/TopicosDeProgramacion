...
void grabarVector(Vector* v, const char* nombreArch); // Graba vector a un archivo
void recorrerVector(const Vector* v, Accion accion, void* datosAccion); // Recorre el vector
